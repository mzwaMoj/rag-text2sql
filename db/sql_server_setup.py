...
def get_product_names():
    ...
    # Return default products if file doesn't exist (without excessive logging)
...
def insert_data_into_sql_server(conn, cursor, df, table_name="customer_information"):
    """Insert data from DataFrame into SQL Server table using pyodbc"""
    try:
...
def main():
    ...
    df = generate_customer_data(n=1000)  # Generate 70 customers
